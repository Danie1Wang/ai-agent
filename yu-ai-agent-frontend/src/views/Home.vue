  ...
  <div class="home-container">
    <div class="header">
      <div class="glitch-wrapper">
        <h1 class="glitch-title">Great AI Agent</h1>
      </div>
      <p class="subtitle">/ Explore Possibilities /</p>
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/love-master')">
        ...
        <div class="app-info">
          <div class="app-title">AI Love Master</div>
          <div class="app-desc">Love Consultant</div>
        </div>
      ...
      <div class="app-card" @click="navigateTo('/super-agent')">
        ...
        <div class="app-info">
          ...
          <div class="app-desc">Help with all sorts of problems</div>
        </div>
        <div class="app-button">
          <span class="btn-text">Try Now</span>
          <span class="btn-icon">→</span>
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'Providing with AI love master and AI agent'
    },
    {
      name: 'keywords',
      content: 'AI agent,AI application,AI love master,AI helper,AI chatting'
    }
  ]
})
